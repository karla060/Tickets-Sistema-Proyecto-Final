...
private void handleModificarUs(ActionEvent event) {
   ...
   /* 
     ...
     @FXML
private void handleRegistrarUs() {
    try {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/vista/GestionUsuario2Vista.fxml"));
        Parent root = loader.load();
        ...
        GestionRolesPermisos2Controller rolesController = new GestionRolesPermisos2Controller();
        ObservableList<String> nombresRoles = rolesController.getNombresDeRoles();

        controller.setListaUsuarios(usuarios); // Pasar la lista de usuarios al formulario
        controller.setListaRoles(nombresRoles); // Pasar los nombres de roles al formulario
    ...
    private void handleRegistrarUs(ActionEvent event) {
        try {
            ...
            // Obtener nombres de roles desde el controlador de roles
            GestionRolesPermisos2Controller rolesController = new GestionRolesPermisos2Controller();
            ObservableList<String> nombresRoles = rolesController.getNombresDeRoles();

            // Pasar la lista de roles al ComboBox del formulario
            controller.setListaRoles(nombresRoles);
            

            GestionDepartamentosController departamentosController = new GestionDepartamentosController();
            ObservableList<String> nombresDepartamentos = departamentosController.getNombresDeDepartamentos();

            // Pasar las listas al controlador de registro de usuarios
            controller.setListaRoles(nombresRoles);
            controller.setListaDepartamentos(nombresDepartamentos);

            // Crear un nuevo Stage para la interfaz de registro
            Stage newStage = new Stage();
            newStage.setScene(new Scene(root));
            newStage.setTitle("Registrar Nuevo Usuario");
            newStage.show();
...
/*
    ...
    private void handleModificarUs(ActionEvent event) {
        try {
            ...
            // Cargar la vista de modificación de usuarios
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/vista/GestionUsuario2Vista.fxml"));
            Parent root = loader.load();
          ...
          // Obtener el controlador del formulario
            ...
            // Obtener nombres de roles y departamentos
            GestionRolesPermisos2Controller rolesController = new GestionRolesPermisos2Controller();
            ObservableList<String> nombresRoles = rolesController.getNombresDeRoles();
            ...
            // Pasar las listas al controlador de modificación de usuarios
            controller.setListaRoles(nombresRoles);
            controller.setListaDepartamentos(nombresDepartamentos);

            // Pasar el usuario seleccionado al controlador
            controller.setUsuarioEnEdicion(seleccionado);

            // Crear un nuevo Stage para la interfaz de modificación
            Stage newStage = new Stage();
            newStage.setScene(new Scene(root));
            newStage.setTitle("Modificar Usuario");
            newStage.show();
